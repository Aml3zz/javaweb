...
<table width = "100%" border = "0" cellpadding = "0" cellspacing = "0">
	<tr>
		<td width = "100" height = "25" align = "center" valign="middle"><a href="updateBusInfo.jsp"><strong>更新站点</strong></a></td>
    	<td width="4" bgcolor="#F0F7FD"></td>
		<td width = "100" height = "25" align = "center" valign="middle" bgcolor="#0082BF"><strong>更新车次</strong></td>
		<td width="4" bgcolor="#F0F7FD"></td>
...
<table width="768" border="1" align="center" cellpadding="1" cellspacing="0" bordercolordark="#ffffff" bordercolor="#ffffff" bordercolorlight="#0082BF">
  ...
  <tr>
    ...
    <td align="center"><a href="updateBusInfo_detail.jsp?busNum=<%=hashMap.get("BusNum")%>">更新</a></td>
  </tr>
  	<%}
  } %>
  <tr>
  	<td colspan = "7">总记录数：<%=count %>&nbsp;&nbsp;总页数：<%=pageCount %>&nbsp;&nbsp;
  	当前页：<%=currentPage%>&nbsp;&nbsp;<%if (pages == 1) {%>首页<%}else {%><a href="updateBusInfo2.jsp?pages=1">首页</a><%}%>
  	&nbsp;&nbsp;<%if (currentPage > 1) {%><a href="updateBusInfo2.jsp?pages=<%=currentPage-1%>">上一页</a><%}
  	else {%>上一页<%}%>&nbsp;&nbsp;<%if (currentPage < pageCount) { %><a href="updateBusInfo2.jsp?pages=<%=currentPage+1%>">下一页</a><%} else{%>
  	下一页<%}%>&nbsp;&nbsp;<%if (currentPage == pageCount || currentPage > pageCount) {%>末页<%} else {%><a href="updateBusInfo2.jsp?pages=<%=pageCount%>">末页</a><%}%>
  	</td>
  </tr>
</table>
</body>
